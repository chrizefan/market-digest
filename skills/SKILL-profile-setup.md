...
Then for each asset class, ask a multi-select preference rating:

| # | Asset Class | Options (pick one) |
|---|-------------|-------------------|
| 20a | US Large Cap | Love it, Like it, Neutral, Not a fan, Avoid |
| 20b | US Mid/Small Cap | Love it, Like it, Neutral, Not a fan, Avoid |
| 20c | International Developed | Love it, Like it, Neutral, Not a fan, Avoid |
| 20d | Emerging Markets | Love it, Like it, Neutral, Not a fan, Avoid |
| 20e | Crypto (BTC/ETH) | Love it, Like it, Neutral, Not a fan, Avoid |
| 20f | Gold | Love it, Like it, Neutral, Not a fan, Avoid |
| 20g | Oil / Energy | Love it, Like it, Neutral, Not a fan, Avoid |
| 20h | Other Commodities | Love it, Like it, Neutral, Not a fan, Avoid |
| 20i | Long-duration Bonds | Love it, Like it, Neutral, Not a fan, Avoid |
| 20j | Short-duration / T-bills | Love it, Like it, Neutral, Not a fan, Avoid |
| 20k | High Yield Credit | Love it, Like it, Neutral, Not a fan, Avoid |

**Preference mapping**: Love it → "Strong preference", Like it → "Above average", Neutral → "Neutral", Not a fan → "Below average", Avoid → "Avoid"
...
**Mapping**: Overweight → "Above average", Neutral → "Neutral", Underweight → "Below average", Avoid → "Avoid"
...
**After answers**: Update §6A regime playbook, §6B thematic tilts, §6C anti-preferences.
