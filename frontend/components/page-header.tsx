...
export default function PageHeader({ title }: PageHeaderProps) {
  ...
  return (
    <header className="flex justify-between items-center px-10 py-6 border-b border-border-subtle bg-bg-glass backdrop-blur-[12px] sticky top-0 z-10 max-md:px-4 max-md:py-3 max-md:pl-14">
