...
**Overall Bias**: [RISK-ON / RISK-OFF / MIXED]

[2-3 sentence narrative of the day's dominant market theme. What is the market primarily reacting to? What is the regime telling us about positioning?]
...
**Central Banks**: [Key Fed/ECB/BOJ signals today]

**Overnight Summary**: [What happened globally]
...
**Sector Rotation**: Leading: [sectors] | Lagging: [sectors]
→ *Implication*: [risk-on/defensive/rotation read]

**Watchlist Movers**:
- [Ticker]: $X (±X%) — [reason]
- [Ticker]: $X (±X%) — [reason]

**VIX**: [X — fear/complacency context]

**Technical Read**: [Trend, breadth, key level]

**Earnings**: [Notable today/tomorrow]
...
**BTC**: $X (±X% 24h) | Key level: X
**ETH**: $X (±X% 24h) | ETH/BTC: X

**Market Cap**: $X | BTC Dominance: X%
**Fear & Greed**: X/100 — [label]

**Alts**: [Notable moves from watchlist]

**Sentiment/Positioning**: [Funding rates, OI, liquidations if notable]

**Narrative**: [Dominant theme]

---

## 🏦 Bonds & Rates

**Bias**: [Bullish bonds / Bearish bonds / Neutral / Conflicted]

**Yields**: 2Y: X% | 10Y: X% | 30Y: X% | Daily Δ: [±Xbps]
**Curve (2s10s)**: Xbps — [inverted/flat/steepening/normalizing]

**Fed**: Rate: X% | Next meeting: [date] | Cut probability: X%

**Credit**: HY spreads [tightening/widening] → [risk signal]
...
**Energy**: WTI: $X (±X%) | Brent: $X | NatGas: $X
**Gold**: $X (±X%) — [signal: safe haven / inflation / real yield]
...
**DXY**: X.XX (±X%) — [strengthening/weakening | implication]
...
> Top items to act on or monitor TODAY, ranked by priority.
...
> What could break the current bias in the next 24-72 hours?

- **[Risk 1]**: [Scenario and trigger to watch]
- **[Risk 2]**: [Scenario and trigger to watch]
- **[Risk 3]**: [Scenario and trigger to watch]
